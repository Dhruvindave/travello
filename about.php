...
<body>
    ...
    <section class="about-us">
        ...
        <div class="about-content">
            <div class="tile1">
                ...
                <p> dolor, sit amet consectetur adipisicing elit. Saepe, laudantium!Lorem ipsum
                ...
                <button class="more-about" type="button">Read More</button>
            </div>
            <div class="tile2">
    ...
    <script>
        ...
        let upto = 0;
        window.onscroll = function(){updated};
        function updated(){
